...
<body>
				...
				<div class="content-main">
					<article class="article">
						...
						<div class="article-util">
							<ul class="article-util-list">
								...
								<li><a class="link-modify-article" href="/index.html">목록</a>
								</li>
							</ul>
						</div>
					</article>
					...
					<div class="qna-comment">
						<div class="qna-comment">
							...
							<div class="qna-comment-articles">

								<c:forEach items="${answer }" var="each">
									<article class="article" id="answer-1405">
										<div class="article-header">
											...
											<div class="article-header-text">
												<a href="/users/1/자바지기" class="article-author-name">${each.writer }</a>
												<a href="#answer-1434" class="article-header-time"
													title="퍼머링크"> <fmt:formatDate
														pattern="yyyy-MM-dd HH:mm:ss" value="${each.createdDate }" />
												</a>
											</div>
										</div>
										<div class="article-doc comment-doc">${each.contents }</div>
										<div class="article-util">
											<ul class="article-util-list">
												<li><a class="link-modify-article"
													href="/qna/updateAnswer?answerId=${each.answerId }">수정</a>
												</li>
												<li>
													<form class="form-delete" action="/qna/deleteAnswer"
														method="POST">
	...
	<article class="article">
		...
		<ul class="article-util-list">
			<li>
				<a class="link-modify-article" href="/qna/updateAnswer/{3}">수정</a>
			</li>
			<li>
